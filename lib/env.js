...
const setup = (startOpts) => {
  ...
  const opts = {
    ...
    userChannelKey: process.env.USER_CHANNEL_KEY || startOpts.userChannelKey || 'ch',
    
    projectKey: process.env.PROJECT_KEY || startOpts.projectKey || 'p', //use this to find parent project
    projectServiceKey: process.env.PROJECT_SERVICE_KEY || startOpts.projectServiceKey || 'pi' 
  }
